...
public class SalaController {
	...
	private final ObservableList<ItemTableView> selectedItens = FXCollections.observableList(new ArrayList<ItemTableView>());
	...
	public void initialize() {
		...
		tableViewItens.setItems(selectedItens);
	}
